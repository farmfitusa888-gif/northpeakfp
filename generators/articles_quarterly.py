...
# ---------------------------------------------------------------------------
{
 ...
 "desc": "The estimated tax calculation in the order you actually do it: income, self-employment tax, deductions, credits, then the shortcut most people should use.",
...
# ---------------------------------------------------------------------------
{
 ...
 "desc": "How to avoid the underpayment penalty without forecasting your year: pay a set percentage of last year's tax and the penalty generally cannot reach you.",
