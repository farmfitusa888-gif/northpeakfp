...
# ---------------------------------------------------------------------------
{
 ...
 "sections": [
   ("Four accounts, and what actually separates them",
    ...
    "more than the marketing does: how much you can put in, who else you have to "
   ...
   ("The question that usually settles it",
    "Do you have employees? Contractors do not count; employees do. If the answer is no, the "
   ...
   ("If it is only you",
    ...
    "as the employee and as the employer, but it is a real plan with real "
   ...
   ("If you have people on payroll",
    ...
    "contribution. Neither is wrong. But the cost of the two is very different once "
   ...
   ("Where the tax benefit actually lands",
    ...
    "worth. In a low-income year, deferring the deduction (or using a Roth) "
...
# ---------------------------------------------------------------------------
{
 ...
 "sections": [
   ("Who puts the money in",
    ...
    "out of personal money. A SEP-IRA is funded by the <strong>employer</strong>; "
    "when you are self-employed, that is still you, but wearing the business hat. "
   ...
   ("The compensation calculation is not what people expect",
    ...
    "self-employment tax and by your own SEP contribution, which makes it circular, "
...
# ---------------------------------------------------------------------------
{
 ...
 "sections": [
   ...
   ("Why that lands harder than it sounds",
    ...
    "payroll for everyone eligible. The plan does not get more expensive gradually; it "
   ...
   ("The mistake that costs the most",
    ...
    "people are eligible, unwinding it is not a paperwork exercise. It has real cost "
   ...
   ("Where I come in",
    ...
    "actually want, and at the headcount you actually expect, all before anything is "
...
# ---------------------------------------------------------------------------
{
 ...
 "sections": [
   ("If the problem is employees",
    ...
    "requirements; " + _a(IRS_SIMPLE, "see the IRS SIMPLE IRA page") + "."),
   ...
   ("If the problem is contribution room",
    ...
    "administration: it is a genuine retirement plan, and once assets pass a threshold "
   ...
   ("If the problem is Roth treatment",
    ...
    "pay tax now and withdraw tax-free later (which can make sense in a low-income "
    "year, or early in a business), a Roth IRA or a Roth option inside a solo 401(k) is "
...
# ---------------------------------------------------------------------------
{
 ...
 "sections": [
   ...
   ("What is shared and what is not",
    ...
    "A SEP contribution is not a deferral but an employer contribution, so "
   ...
   ("Where people get it wrong",
    ...
    "self-employment earnings. Assuming a 403(b) at work blocks a SEP entirely (it "
   ...
   ("If there is also a 457(b)",
    ...
    "expects, and more ways to trip over the interaction. That combination is worth "
   ...
   ("What this is not",
    ...
    "I am not a registered investment adviser, so nothing here is a recommendation about "
...
# ---------------------------------------------------------------------------
{
 ...
 "sections": [
   ("Who funds it",
    "A SEP is funded entirely by the employer: employees put in nothing, and "
   ...
   ("How the employer cost behaves",
    ...
    "match, your cost scales with participation; you pay for the people who choose to "
   ...
   ("The honest way to choose",
    ...
    "answer is rarely ambiguous once the numbers are on the page, and it is frequently "
...
# ---------------------------------------------------------------------------
{
 ...
 "sections": [
   ("Reason one: you want more in at the same income",
    ...
    "employer, so at moderate income levels you can generally get more in than a SEP "
   ...
   ("Reason two: you want Roth treatment",
    ...
    "(a first year, a slow year, a year you took time off), the deduction is "
   ...
   ("Reason three: you want to borrow against it",
    ...
    "Usually the answer is no, but if the option matters to you, only one of "
    "these two offers it."),
   ...
   ("And the condition that ends the conversation",
    ...
    "spouse. Hire someone who qualifies and the plan stops being a solo 401(k) and "
   ...
   ("Timing matters more than people think",
    ...
    "the following year rather than rush it, and a genuine reason to decide in "
...
# ---------------------------------------------------------------------------
{
 ...
 "sections": [
   ...
   ("Why that last part makes it circular",
    ...
    "trick; it is the same logic that stops an employer deduction from inflating the "
    "base it is calculated from. But it is why a mental estimate is almost always too "
    "high."),
   ...
   ("What to do before you fund it",
    ...
    "year is closed. SEPs are relatively forgiving on timing, which makes that "
   ...
   ("Where I help",
    ...
    "minutes. If it is not, the calculation is a guess, and a guess is how the "
