...
# LASTMOD used to be date.today(), which made a rebuild that changed nothing
# announce all 77 pages as freshly modified. Both are now marks: page_dates.py
# swaps them for this page's own two dates as it is written. See page_dates.py.
from page_dates import PUBLISHED_MARK as PUBDATE, MODIFIED_MARK as LASTMOD
...
ARTICLES = [
    ...
    },
    {
        ...
        "sections": [
            ...
            ("The Break-Even Point", "The extra payroll filings and bookkeeping an S-Corp requires cost money, so the election only pays off above a certain profit level, often around the point where net profit clears roughly $40,000 to $50,000, though it varies. See the <a href=\"https://www.irs.gov/businesses/small-businesses-self-employed/s-corporations\" rel=\"noopener\" target=\"_blank\">IRS S-Corp overview</a> for the rules."),
    ...
    },
    {
        ...
        "sections": [
            ...
            ("How to Estimate the Amount", "A common approach is to set aside a percentage of every payment you receive (often 25 to 30%) into a separate account. A safer method is the safe-harbor rule below."),
    ...
    },
    {
        ...
        "sections": [
            ...
            ("The Simplified Method", "Deduct a flat rate per square foot of office space, up to a cap. Minimal records and no tracking of individual home bills, which makes it ideal for smaller spaces. The <a href=\"https://www.irs.gov/businesses/small-businesses-self-employed/home-office-deduction\" rel=\"noopener\" target=\"_blank\">IRS home office page</a> lists the current rate."),
    ...
    },
    {
        ...
        "sections": [
            ...
            ("Deadlines Matter", "Setup and funding deadlines differ by plan and can fall before you file. Miss them and the tax benefit for the year is gone, so plan ahead."),
        ],
    },
    {
        ...
        "sections": [
            ...
            ("Keep Deductions Reasonable and Documented", "Unusually large deductions relative to income can draw scrutiny. The deductions themselves are fine; what protects you is the documentation behind each one."),
            ...
            ("Mind the Home Office and Vehicle Claims", "These are legitimate but historically flagged. Claim them, but keep the logs and measurements that prove them, as covered in our other guides."),
    ...
    },
    {
        ...
        "sections": [
            ("Choose Your Structure Deliberately", "Sole proprietorship, LLC, or S-Corp each carry different tax and liability consequences. The default isn't always best, and a quick professional conversation upfront can shape years of savings."),
    ...
    },
    {
        ...
        "read": "6 min read",
        "lede": "Hiring your first employee is a milestone. It is also a new set of obligations. Here's the payroll groundwork you need to get right.",
        "sections": [
    ...
    },
    {
        ...
        "sections": [
            ...
            ("A Year-Round Conversation", "Planning means checking in at key moments rather than once at the deadline: mid-year, before big purchases, when income shifts. Small adjustments compound."),
